...
@WebServlet(
        name = "com.example.lesson10.servlet.admin.AdminBookDeleteServlet",
        urlPatterns = "/admin/book/delete/*"
)
public class AdminBookDeleteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher requestDispatcher = req.getRequestDispatcher("/views/admin/delete_book.jsp");
        req.setAttribute("book", bookDAO.findById(id));
        requestDispatcher.forward(req, resp);
        System.out.println("book: " + bookDAO.findById(id));
    }
